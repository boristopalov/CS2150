 ...
 *
 * @brief MiddleEarth class description
 **/
...
/**
 * @brief shuffles the cities
 *
 * @details This method uses the Mersenne-Twister RNG to shuffle a vector of strings; we will use this method to shuffle our vector of cities so that they are randomly placed in our world
 *
 * 
 * @param first iterator pointing to where we want to start shuffling the vector (will be start of vector in our code)
 * @param last iterator pointing to where we want to finish shuffling (will be end of the vector in our code so that the entire vector gets shuffled)
 * @param g Mersenne-Twister randomg number generator
 *
 *
 *
 **/
